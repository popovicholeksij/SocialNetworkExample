...
<html>
	<head>
		<meta charset="UTF-8">
		<title>Заблоковані користувачі - ${thisUser.getFirstName()} ${thisUser.getSecondName()}</title>
		...
		<script type="text/javascript"> 
			$( document ).ready(function() {
				$("a[class='glyphicon glyphicon-remove-circle']").click(function () {
					...
					var url = 'deletefromignore.action?userignoreid=' + userId;
	...
	<body>
		...
		<div class="container">
			...
			<c:choose>
				<c:when test="${ignoreList.isEmpty()}">
					<p>Ви не блокували інших користувачів</p>
				</c:when>
				<c:otherwise>
					<c:forEach var="eachUser" items="${ignoreList}">	
